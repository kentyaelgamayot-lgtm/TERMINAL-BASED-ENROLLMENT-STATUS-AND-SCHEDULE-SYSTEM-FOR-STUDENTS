...
# Enrollment Status and Schedule System
...
def add_student():
    ...
    print(f"\nâœ… Record added for {stud_name} ({stud_id})")
...
def student_portal():
    ...
    if stud_id in students:
        ...
        print("\nâŒ No record found for that Student ID. Please contact your admin.")

def main():
    print("ðŸŽ“ WELCOME TO ENROLLMENT STATUS AND SCHEDULE SYSTEM ðŸŽ“")
    ...
    while True:
        ...
        if choice == "1":
            ...
            if username in admins and admins[username] == password:
                ...
                print("âŒ Invalid Admin Credentials.")
        elif choice == "2":
            student_portal()
        elif choice == "3":
